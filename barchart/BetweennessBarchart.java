...
public class BetweennessBarchart extends JFrame {

    private static final long serialVersionUID = 1L;

  /*  public BetweennessBarchart(final String title) {
        super(title);
    ...
    private CategoryDataset createDataset() {
      ...
      //         jlist11.add(j.getValueAt(e, 0).toString());
       ...
       final String rowName = "Betweenness";
    ...
    public BetweennessBarchart(final String args) {
       // super(title);
        this.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        final CategoryDataset dataset = createDataset();
        final JFreeChart chart = createChart(dataset);
...
setVisible(true);
setSize(500, 500);
        //final BetweennessBarchart test = new BetweennessBarchart("Test");
        //test.pack();
