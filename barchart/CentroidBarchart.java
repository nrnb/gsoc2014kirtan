...
public class CentroidBarchart extends JFrame {
  ...
  /*  public NewClass(final String title) {
    ...
    private CategoryDataset createDataset() {
      ...
      j= new JTable();
               ...
               for(int e=0;e<j.getRowCount();e++)
       {
           ...
           if (j.getValueAt(e, 0).toString().endsWith("% Centroid")==true)
           {
    ...
    private JFreeChart createChart(final CategoryDataset dataset) {
        ...
        renderer.setSeriesPaint(0, Color.decode("#FF8C00"));
        return chart;
    }

    public CentroidBarchart(final String args) {
       // super(title);
        this.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        final CategoryDataset dataset = createDataset();
        final JFreeChart chart = createChart(dataset);
