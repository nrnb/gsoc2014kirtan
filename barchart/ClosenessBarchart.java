...
public class ClosenessBarchart extends JFrame {
  ...
  /*  public NewClass(final String title) {
    ...
    private CategoryDataset createDataset() {
      ...
      j= new JTable();
               ...
               for(int e=0;e<j.getRowCount();e++)
       {
           ...
           if (j.getValueAt(e, 0).toString().endsWith("% Closeness")==true)
           {
      ...
      //         jlist11.add(j.getValueAt(e, 0).toString());
       ...
       final String rowName = "Closeness";
    ...
    public ClosenessBarchart(final String args) {
       // super(title);
        this.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        final CategoryDataset dataset = createDataset();
        final JFreeChart chart = createChart(dataset);
