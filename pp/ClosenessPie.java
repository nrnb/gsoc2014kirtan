...
//    public static IntMyBarRenderer mybarrenderer;
   ...
   // public Vector centralities;
     ...
     */
    public ClosenessPie(CyNode node, Vector centr,String title) {
    ...
    private  PieDataset createDataset() {
        ...
        if(cent1.getName().toString().endsWith("% Closeness")==true)
        //if(n==0)
        {
...
*/
    ...
    private static JFreeChart createChart(PieDataset dataset) {
        ...
        JFreeChart chart = ChartFactory.createPieChart(
            "Pie Chart for Closeness",  // chart title
   dataset,true,true,true
    ...
    //public static void main(String[] args) {
        ...
        //NewClass demo = new ClosenessPie("Pie Chart Demo 1");
       // demo.pack();
