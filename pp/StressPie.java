...
//    public static IntMyBarRenderer mybarrenderer;
   ...
   // public Vector centralities;
     ...
     */
    public StressPie(CyNode node, Vector centr,String title) {
    ...
    private  PieDataset createDataset() {
        ...
        IntCentrality cent1 = (IntCentrality) it.next();
         if(cent1.getName().toString().endsWith("% Stress")==true)
...
*/
    ...
    private static JFreeChart createChart(PieDataset dataset) {
        ...
        JFreeChart chart = ChartFactory.createPieChart(
            "Pie Chart for Stress",  // chart title
